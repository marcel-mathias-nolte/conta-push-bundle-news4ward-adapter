...
namespace MarcelMathiasNolte\ContaoPushBundleNews4wardAdapterBundle\DependencyInjection;
...
class ContaoPushBundleNews4wardAdapterExtension extends Extension
{
	/**
	 * {@inheritdoc}
	 */
